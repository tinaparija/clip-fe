	  	 ...
	  	 <div className = "row">
	      	<div className = "col col-md-8 offset-md-2 new_clip">
		      	<form onSubmit={this.postClip}>
					...
					<input type="username" maxlength="30" className="form-control" id="username" onChange={this.updateMyState('concept')} placeholder="Concept / Title"/>
					</div>
					<div className="form-group">
					
					<textarea className="form-control" maxlength="500" rows="8" onChange={this.updateMyState('content')} placeholder="Content"></textarea>
